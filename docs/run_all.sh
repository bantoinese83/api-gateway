...
stop_services() {
  ...
  pkill -f "uvicorn src.main:app --host 0.0.0.0 --port 8080"
  echo "Stopping service-b..."
  pkill -f "uvicorn src.main:app --host 0.0.0.0 --port 8002"
  echo "Stopping service-a..."
  pkill -f "uvicorn src.main:app --host 0.0.0.0 --port 8001"
